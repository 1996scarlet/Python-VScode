...
class ZHX_ROC:
    ...
    def make_roc():
        ...
        plt.plot(fpr, tpr, label = 'BNB AUC = %0.9f' % roc_auc)
        plt.plot(fpr1, tpr1, label = 'MNB AUC = %0.9f' % roc_auc1)
        plt.plot(fpr2, tpr2, label = 'LR AUC = %0.9f' % roc_auc2)
        plt.plot(fpr3, tpr3, label = 'GNB AUC = %0.9f' % roc_auc3)
        plt.plot(fpr4, tpr4, label = 'MLP AUC = %0.9f' % roc_auc4)
